    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              Our innovative Hospital Management System, developed on the robust Spring Boot framework, optimizes healthcare administration, ensuring efficient patient care. Seamlessly integrating departments and functionalities, it simplifies tasks such as patient data management, appointment scheduling, staff allocation, inventory control, and reporting, revolutionizing our hospital's operations.
          </b>
        </p>
        </div>
      </div>
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                ...
                Rohit Barik | Rajat Bargoti | Ishaan Rejra | Akshat Swaminathan
            </b>
        </p>
        </div>
      </div>
